export default function Terms() {
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px", fontFamily: "sans-serif", color: "#e8e8e8", background: "#040608", minHeight: "100vh" }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8 }}>Terms &amp; Conditions</h1>
      <p style={{ color: "#999", marginBottom: 32 }}>Effective date: 2026-04-20</p>

      <p>These terms and conditions apply to the <strong>Outfield</strong> app (hereby referred to as "Application") for mobile devices that was created by <strong>Maaz Khan</strong> (hereby referred to as "Service Provider") as a Free service.</p>
      ...
      <h2 style={h2}>Changes to These Terms and Conditions</h2>
      ...
      <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:outfield.application@gmail.com" style={link}>outfield.application@gmail.com</a>.</p>
    </div>
  );
}
